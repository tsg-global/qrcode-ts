import QRMaskPattern from "qrcode/qr_mask_pattern";
import QRMath from "qrcode/qr_math";
        ...
        if (1 <= type && type < 10) {
            switch (mode) {
                ...
                case QRMode.MODE_KANJI:
                    return 8;
                default:
                    throw new Error("mode:" + mode); } } else if (type < 27) {
            switch (mode) {
                case QRMode.MODE_NUMBER:
                    return 12;
                case QRMode.MODE_ALPHA_NUM:
                ...
                case QRMode.MODE_KANJI:
                    return 10;
                default:
                    throw new Error("mode:" + mode); } } else if (type < 41) {
            switch (mode) {
                case QRMode.MODE_NUMBER:
                    return 14;
                case QRMode.MODE_ALPHA_NUM:
                ...
                case QRMode.MODE_KANJI:
                    return 12;
                default:
                    throw new Error("mode:" + mode); } } else {
